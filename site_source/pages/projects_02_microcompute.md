...
The library also has good documentation, generated using [mini_doc_gen.py](projects_06_doc.md). The documentation is available [here](https://github.com/kal39/microcompute/blob/main/doc.md).
